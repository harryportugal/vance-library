...
const loginTranslations = {
  ...
  es: {
    ...
    selectPlanDesc: "Selecciona la mejor opção para comenzar",
...
export default function Login({ lang, onLogin, initialMode = 'signin' }: LoginProps) {
  ...
  // Auto-detect password reset token in URL on mount
  useEffect(() => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Successful signup, transition to Plan selection
        setMode('plans');
      }
    } catch (err) {
      setErrorMessage("Erro ao conectar com o servidor. Tente novamente.");
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        setSuccessMessage("Se o e-mail estiver cadastrado, as instruções foram enviadas!");
      }
    } catch (err) {
      setErrorMessage("Erro ao conectar com o servidor. Tente novamente.");
    }
              ...
              >
                <div className="w-full my-auto space-y-5 relative z-10">
                  ...
                  <motion.div variants={itemVariants} className="text-center">
                    <h1 className="text-[36px] font-semibold text-zinc-950 tracking-tight leading-none">
                      {t.welcomeBack}
                    </h1>
                  ...
                  {/* Feedback Messages */}
                  {errorMessage && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-2 px-4 bg-red-50 text-red-600 rounded-xl text-xs font-semibold">
                      {errorMessage}
                    </motion.div>
                  )}

                  {/* Form */}
                  <motion.form variants={itemVariants} onSubmit={handleSignIn} className="space-y-3.5">
                    {/* Email Input */}
                    <div className={`border rounded-[1.25rem] p-2.5 pl-5 pr-2.5 flex items-center transition-all duration-300 ${
                      focusedField === 'email' ? 'border-gray-900 bg-white shadow-sm' : 'border-gray-200 bg-gray-50'
                    }`}>
                      <div className="flex-1 min-w-0 pr-2 flex flex-col">
                        <label className="text-[10px] font-bold text-gray-400 tracking-wider uppercase select-none">{t.email}</label>
                        <input
                          type="email"
                          required
                          value={email}
                    ...
                    {/* Password Input */}
                    <div className={`border rounded-[1.25rem] p-2.5 pl-5 pr-2.5 flex items-center transition-all duration-300 ${
                      focusedField === 'password' ? 'border-gray-900 bg-white shadow-sm' : 'border-gray-200 bg-gray-50'
                    }`}>
                      <div className="flex-1 min-w-0 pr-2 flex flex-col">
                        <label className="text-[10px] font-bold text-gray-400 tracking-wider uppercase select-none">{t.password}</label>
                        <input
                          type="password"
                          required
                          value={password}
                    ...
                    <div className="text-right px-1">
                      <button
                        ...
                        className="text-xs text-zinc-500 hover:text-zinc-950 font-semibold underline decoration-zinc-200 hover:decoration-zinc-950 transition-all cursor-pointer"
                      >
                        {t.forgotPassword}
                      </button>
                    </div>
                    ...
                    <motion.div 
                      ...
                      className="relative group w-full h-[52px] flex items-center justify-center mt-4"
                    >
                      ...
                      >
                        <span className="mr-2">{t.signIn}</span>
            ...
            {mode === 'signup' && (
              ...
              >
                <div className="w-full my-auto space-y-5 relative z-10">
                  ...
                  {/* Form */}
                  <motion.form variants={itemVariants} onSubmit={handleSignUp} className="space-y-3">
                    {/* Name Input */}
                    <div className={`border rounded-[1.25rem] p-2.5 pl-5 pr-2.5 flex items-center transition-all duration-300 ${
                      focusedField === 'name' ? 'border-gray-900 bg-white shadow-sm' : 'border-gray-200 bg-gray-50'
                    }`}>
                      <div className="flex-1 min-w-0 pr-2 flex flex-col">
                        <label className="text-[10px] font-bold text-gray-400 tracking-wider uppercase select-none">{t.name}</label>
                        <input
                          type="text"
                          required
                          value={name}
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute inset-[2.5px] rounded-full bg-black flex items-center justify-center text-white shadow-[inset_0_2px_4px_rgba(255,255,255,0.15),inset_0_-2px_4px_rgba(0,0,0,0.8)] cursor-pointer font-bold text-xs uppercase tracking-wider"
                      >
                        <span className="mr-2">{t.createAccount}</span>
                        <ArrowRight className="w-4 h-4 text-white" />
                      </button>
                    </motion.div>
                  </motion.form>
            ...
            {mode === 'forgot' && (
              ...
              >
                <div className="w-full my-auto space-y-5 relative z-10">
                  ...
                  {successMessage && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-2 px-4 bg-emerald-50 text-emerald-600 rounded-xl text-xs font-semibold">
                      {successMessage}
                    </motion.div>
                  )}
                  ...
                  <motion.form variants={itemVariants} onSubmit={handleForgotPassword} className="space-y-4">
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute inset-[2.5px] rounded-full bg-black flex items-center justify-center text-white shadow-[inset_0_2px_4px_rgba(255,255,255,0.15),inset_0_-2px_4px_rgba(0,0,0,0.8)] cursor-pointer font-bold text-xs uppercase tracking-wider"
                      >
                        <span className="mr-2">{t.sendResetLink}</span>
                        <ArrowRight className="w-4 h-4 text-white" />
                      </button>
                    </motion.div>
                  </motion.form>
                ...
                <div className="w-full my-auto space-y-5 relative z-10">
                  ...
                  <motion.form variants={itemVariants} onSubmit={handleResetPassword} className="space-y-4">
                    ...
                    <div className={`border rounded-[1.25rem] p-2.5 pl-5 pr-2.5 flex items-center transition-all duration-300 ${
                      ...
                      <div className="flex-1 min-w-0 pr-2 flex flex-col">
                        <label className="text-[10px] font-bold text-gray-400 tracking-wider uppercase select-none">Nova Senha</label>
                        <input
                          type="password"
                          required
                          value={password}
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute inset-[2.5px] rounded-full bg-black flex items-center justify-center text-white shadow-[inset_0_2px_4px_rgba(255,255,255,0.15),inset_0_-2px_4px_rgba(0,0,0,0.8)] cursor-pointer font-bold text-xs uppercase tracking-wider"
                      >
                        <span className="mr-2">{t.updatePassword}</span>
                        <ArrowRight className="w-4 h-4 text-white" />
                      </button>
                    </motion.div>
                  </motion.form>
