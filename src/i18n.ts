...
export const translations = {
  pt: {
    ...
    latestComponents: 'Últimos componentes [Passe o mouse para ver]',
    outOfTheBox: 'Prontos para Uso',
    outOfTheBoxDesc: 'Componentes prontos para usar e integrar no seu projeto [Passe o mouse para ver]',
    matchesForQuery: 'Resultados para a busca:',
    sort: 'Ordenar',
    source: 'Código',
    free: 'Grátis',
    pro: 'Pro',
  ...
  en: {
    ...
    latestComponents: 'Latest components [Hover to play video]',
    outOfTheBox: 'Out of the box',
    outOfTheBoxDesc: 'Collection of out of the box components [Hover to play video]',
    matchesForQuery: 'Matches for query:',
    sort: 'Sort',
    source: 'Source',
    free: 'Free',
    pro: 'Pro',
  ...
  es: {
    ...
    latestComponents: 'Últimos componentes [Pase el mouse para ver]',
    outOfTheBox: 'Listos para Usar',
    outOfTheBoxDesc: 'Colección de componentes listos para usar [Pase el mouse para ver]',
    matchesForQuery: 'Resultados para la búsqueda:',
    sort: 'Ordenar',
    source: 'Código',
    free: 'Gratis',
    pro: 'Pro',
