...
void main() {
	...
	`}var ka=class extends Et{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Vr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=qo(i,i.VERTEX_SHADER,y),S=qo(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=$o(i,x,`vertex`),n=$o(i,S,`fragment`);H(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,Ac={maskRadius:.15,maskSpeed:.75,lerpFactor:.05,radiusLerpSpeed:.1,turbulenceIntensity:.075};document.querySelectorAll(`.inversion-lens`).forEach(e=>{jc(e)});function jc(e){let t,n,r,i,a=new G(.5,.5),s=new G(.5,.5),c=0,u=!1,d=0,f=0,p=e.querySelector(`img`);new Ti().load(p.src,e=>{m(e),h(),g(),v()});let m=a=>{let s=a.image.width/a.image.height;a.minFilter=l,a.magFilter=o,a.anisotropy=16,t=new fn;let c=e.clientWidth,u=e.clientHeight;n=new Pi(-1,1,1,-1,0,1),i={u_texture:{value:a},u_mouse:{value:new G(.5,.5)},u_time:{value:0},u_resolution:{value:new G(c,u)},u_radius:{value:0},u_speed:{value:Ac.maskSpeed},u_imageAspect:{value:s},u_turbulenceIntensity:{value:Ac.turbulenceIntensity}};let d=new kr(new Kr(2,2),new ti({uniforms:i,vertexShader:Oc,fragmentShader:kc}));t.add(d),r=new mc({antialias:!0}),r.setPixelRatio(window.devicePixelRatio),r.setSize(c,u),r.capabilities.anisotropy=16,e.appendChild(r.domElement)},h=()=>{let e=new Dc;e.domElement.style.position=`absolute`,e.domElement.style.top=`10px`,e.domElement.style.right=`10px`,e.add(Ac,`maskRadius`,.05,1,.01).name(`Mask Radius`),e.add(Ac,`turbulenceIntensity`,0,1,.001).name(`Turbulence`).onChange(e=>{i&&(i.u_turbulenceIntensity.value=e)})},g=()=>{document.addEventListener(`mousemove`,e=>{_(e.clientX,e.clientY)}),window.addEventListener(`scroll`,()=>{_(d,f)}),new IntersectionObserver(e=>{e.forEach(e=>{u=e.isIntersecting,u||(c=0)})},{threshold:.1}).observe(e)},_=(t,n)=>{d=t,f=n;let r=e.getBoundingClientRect();t>=r.left&&t<=r.right&&n>=r.top&&n<=r.bottom?(a.x=(t-r.left)/r.width,a.y=1-(n-r.top)/r.height,c=Ac.maskRadius):c=0},v=()=>{requestAnimationFrame(v),s.lerp(a,Ac.lerpFactor),i&&(i.u_mouse.value.copy(s),i.u_time.value+=.01,i.u_radius.value+=(c-i.u_radius.value)*Ac.radiusLerpSpeed),r&&t&&n&&r.render(t,n)}}