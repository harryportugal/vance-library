...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ea(e,t,n){let r=new Float32Array(fa),i=new K(0,1,0);return new ti({name:`SphericalGaussianBlur`,defines:{n:fa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ka(),fragmentShader:`
	...
	`}var Aa=class extends Dt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Vr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ns={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function rs(e,t){let n=ns[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var is=new K;function as(){return J.getLuminanceCoefficients(is),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${is.x.toFixed(4)}, ${is.y.toFixed(4)}, ${is.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
    ...
    `}},bc=class extends rn{isExtendedObject3D=!0;resize(e){}update(e){}},xc={THREE_CONTAINER:`THREE-CONTAINER`},Sc=class{static#e=!1;static#t=0;static#n=0;static#r=new Set;static Start(){this.#e=!0,this.#t=performance.now(),this.#i()}static Stop(){this.#e=!1}static Add(e){this.#r.add(e)}static Remove(e){this.#r.delete(e)}static#i=()=>{this.#a(),this.#e&&requestAnimationFrame(this.#i)};static#a=()=>{let e=performance.now(),t=e-this.#t;this.#n+=t,this.#t=e;for(let e of this.#r)e(t*.001)};static get IsRunning(){return this.#e}static get CurrentTime(){return this.#t}static get ElapsedTime(){return this.#n}static get ElapsedTimeInSeconds(){return this.#n/1e3}},Cc=class{static#e=new pn;static#t;static#n;static#r;static#i=new Set;static Init(){this.#o(),this.#a(),this.#s(),window.addEventListener(`resize`,this.#c),Sc.Add(this.#l)}static Add(e){e.traverse(e=>{e.isExtendedObject3D&&this.#i.add(e)}),this.#e.add(e)}static Remove(e){e.traverse(e=>{e.isExtendedObject3D&&this.#i.delete(e)}),this.#e.remove(e)}static#a(){this.#t=document.getElementById(xc.THREE_CONTAINER),this.#t.appendChild(this.#r.domElement)}static#o(){this.#r=new hc({antialias:!0,alpha:!0,powerPreference:`high-performance`}),this.#r.toneMapping=4,this.#r.setSize(window.innerWidth,window.innerHeight),this.#r.setPixelRatio(window.devicePixelRatio)}static#s(){this.#n=new Pi(-1,1,1,-1),this.#n.position.z=5}static#c=e=>{this.#r.setSize(window.innerWidth,window.innerHeight);for(let t of this.#i)t.resize(e)};static#l=e=>{this.#r.render(this.#e,this.#n);for(let t of this.#i)t.update(e)};static get Scene(){return this.#e}static get Camera(){return this.#n}static get Renderer(){return this.#n}static get Canvas(){return this.#r.domElement}};Math.PI/180,180/Math.PI;function wc(e,t,n,r,i){return r+(e-t)*(i-r)/(n-t)}var Tc=class t extends bc{static#e=new K;static#t=new K;static#n=[e.TEXTURE_1,e.TEXTURE_2,e.TEXTURE_3,e.TEXTURE_4,e.TEXTURE_5,e.TEXTURE_6,e.TEXTURE_7,e.TEXTURE_8,e.TEXTURE_9,e.TEXTURE_10];static Geometry=new Kr(1,1);#r=new K().setScalar(.4);#i=new K;#a=new K;#o=new K;mesh;material;gridPosition=new G;constructor(e,t){super(),this.gridPosition.set(e,t),this.#s(),this.#c(),this.scale.copy(this.#r)}#s(){let e=Math.floor(Math.random()*t.#n.length),n=t.#n[e],r=vc.GetAsset(n);this.material=new yc({uniforms:{uDistance:new Xi(0),uTexture:new Xi(r)}}),this.mesh=new kr(t.Geometry,this.material),this.mesh.scale.copy(t.#e),this.add(this.mesh)}#c(){let{x:e,y:n}=this.gridPosition,r=t.#e.x*.5,i=t.#e.y*.5;e=wc(e,0,Ec.COLUMNS,Cc.Camera.left,Cc.Camera.right)+r,n=wc(n,0,Ec.ROWS,Cc.Camera.bottom,Cc.Camera.top)+i,this.#a.set(e,n,0)}static SetScale(){let e=window.innerWidth/window.innerHeight,t=(Cc.Camera.right-Cc.Camera.left)/Ec.COLUMNS;this.#e.x=t,this.#e.y=t*e;let n=window.innerWidth<window.innerHeight?2:4;this.#t.copy(this.#e).multiplyScalar(n)}resize(e){this.mesh.scale.copy(t.#e)}update(e){this.#u(e),this.#l(e)}#l(e){let t=Math.abs(this.#a.x-this.position.x);this.#o.set(this.#a.x,t<.075?this.#a.y:0,this.position.z),this.position.lerp(this.#o,1-(.005/Ec.COLUMNS)**e)}#u(e){let n=window.innerWidth/window.innerHeight,r=Ec.MousePosition.x-this.position.x,i=Ec.MousePosition.y-this.position.y;i/=n;let a=r**2+i**2;a*=n>1?12:3,this.#i.lerpVectors(t.#e,t.#t,Math.max(1-a,0)),this.mesh.scale.lerp(this.#i,1-2e-4**e),this.position.z=-a,this.material.uniforms.uDistance.value=a}},Ec=class e extends bc{static COLUMNS=Math.floor(window.innerWidth/100)|1;static ROWS=Math.floor(window.innerHeight/100)|1;static MousePosition=new G;#e=new G;constructor(){super(),Tc.SetScale(),this.#n(),this.#t()}#t(){window.addEventListener(`mousemove`,this.#r),window.addEventListener(`touchmove`,this.#r)}#n(){for(let t=0;t<e.COLUMNS;t++)for(let n=0;n<e.ROWS;n++){let e=new Tc(t,n);this.add(e)}}#r=e=>{let{clientX:t,clientY:n}=e.type===`touchmove`?e.changedTouches[0]:e,r=.5*window.innerWidth,i=.5*window.innerHeight,a=(t-r)/window.innerWidth*2,o=-(n-i)/window.innerHeight*2;this.#e.set(a,o)};resize(){e.COLUMNS=Math.floor(window.innerWidth/100)|1,e.ROWS=Math.floor(window.innerHeight/100)|1,Tc.SetScale()}update(e){this.#i(e)}#i(t){e.MousePosition.lerp(this.#e,1-.0125**t)}};(class{static async Init(){Cc.Init(),Sc.Start(),await this.#e(),this.#t()}static async#e(){vc.AddTexture(e.TEXTURE_1,`textures/img1.webp`),vc.AddTexture(e.TEXTURE_2,`textures/img2.webp`),vc.AddTexture(e.TEXTURE_3,`textures/img3.webp`),vc.AddTexture(e.TEXTURE_4,`textures/img4.webp`),vc.AddTexture(e.TEXTURE_5,`textures/img5.webp`),vc.AddTexture(e.TEXTURE_6,`textures/img6.webp`),vc.AddTexture(e.TEXTURE_7,`textures/img7.webp`),vc.AddTexture(e.TEXTURE_8,`textures/img8.webp`),vc.AddTexture(e.TEXTURE_9,`textures/img9.webp`),vc.AddTexture(e.TEXTURE_10,`textures/img10.webp`),await vc.Load()}static#t(){Cc.Add(new Ec)}}).Init();